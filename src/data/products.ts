...
export const categories: Category[] = [
  ...
  { id: "ceo-tables", name: "CEO Tables", description: "Flagship executive tables with veneer finish, integrated credenzas, and AV modules for C-suite offices.", productCount: ceoTables.length, image: deskExecutiveImg },
  { id: "executive-tables", name: "Executive Tables", description: "Professional desks for directors and senior managers with cable management and pedestals.", productCount: executiveTables.length, image: deskExecutiveImg },
  { id: "manager-tables", name: "Manager Tables", description: "Mid-level management desks with L-shape options, drawers, and smart features.", productCount: managerTables.length, image: deskExecutiveImg },
  ...
  { id: "workstations", name: "Workstations", description: "Modular 2, 4, 6-person clusters, linear benching, cubicles, and open-plan desk systems.", productCount: workstations.length, image: workstationImg },
  ...
  { id: "meeting-tables", name: "Meeting Tables", description: "Conference tables from 4-seater to boardroom size with integrated power and AV.", productCount: meetingTables.length, image: meetingRoomImg },
  ...
  { id: "dining", name: "Dining Furniture", description: "Dining sets, dining chairs, and dining tables in solid wood, glass, and modern finishes.", productCount: diningFurniture.length, image: meetingRoomImg },
];
